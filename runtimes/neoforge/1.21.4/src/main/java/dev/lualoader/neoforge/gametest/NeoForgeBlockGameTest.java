...
public class NeoForgeBlockGameTest {
    ...
    public static void blocoDeclaradoEstaRegistrado(GameTestHelper helper) {
        Block block = BuiltInRegistries.BLOCK.getOptional(RUBY_BLOCK).orElse(null);
    ...
    public static void itemDoBlocoExiste(GameTestHelper helper) {
        Item item = BuiltInRegistries.ITEM.getOptional(RUBY_BLOCK).orElse(null);
    ...
    public static void armaduraDeclaradaVesteNoSlotCerto(GameTestHelper helper) {
        ...
        var equipped = armor.getDefaultInstance().get(
                net.minecraft.core.component.DataComponents.EQUIPPABLE);
        if (equipped == null
                || equipped.slot() != net.minecraft.world.entity.EquipmentSlot.HEAD) {
            throw new AssertionError("o elmo deveria vestir na cabeca, veio "
                    + (equipped == null ? null : equipped.slot()));
        }
        helper.succeed();
    }
    ...
    public static void oCanoConectaComOVizinho(GameTestHelper helper) {
        Block cano = BuiltInRegistries.BLOCK.getOptional(
                ResourceLocation.fromNamespaceAndPath("tubos", "tubo")).orElse(null);
    ...
    public static void oTiqueAgendadoEntraNaFilaDoJogo(GameTestHelper helper) {
        Block cano = BuiltInRegistries.BLOCK.getOptional(ResourceLocation.parse("tubos:tubo")).orElse(null);
        if (cano == null || cano == net.minecraft.world.level.block.Blocks.AIR) {
            throw new AssertionError("o tubo do exemplo nao foi registrado");
        }
