...
public final class ScreenRenderer {
    ...
    private static void esticar(DrawContext context, Identifier textura,
        ...
        context.drawTexture(net.minecraft.client.render.RenderLayer::getGuiTextured,
                textura, x, y, (float) u, (float) v, larguraDestino, alturaDestino,
    ...
    private static void map(DrawContext context, TextRenderer textRenderer,
        ...
        if (element.mapRound()) drawEllipseCorners(context, x, y, width, height);
        ...
        if (north != null && !north.isBlank()) {
            context.drawText(textRenderer, Text.literal(north),
                    centerX - textRenderer.getWidth(north) / 2, y + 3, 0xFFFFFFFF, true);
        }
    }
    ...
    private static net.minecraft.entity.LivingEntity livingEntity(Identifier id) {
        ...
        try {
            ...
            if (world != null && type != null) {
                var entity = type.create(world, net.minecraft.entity.SpawnReason.COMMAND);
