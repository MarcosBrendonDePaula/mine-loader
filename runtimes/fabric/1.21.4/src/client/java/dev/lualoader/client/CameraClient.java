...
public final class CameraClient {
    ...
    public static void set(int version, String definitions) {
        if (version != CameraProtocol.VERSION) {
            LuaLoaderClient.LOGGER.warn("Catálogo de câmeras em versão {} ignorado; esta em uso a {}",
        ...
        try {
            ...
            LuaLoaderClient.LOGGER.warn("Catálogo de câmeras inválido: {}", error.getMessage());
        }
    }
