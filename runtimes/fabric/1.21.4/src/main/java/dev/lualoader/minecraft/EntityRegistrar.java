...
public final class EntityRegistrar {
    ...
    private EntityType<?> build(Identifier id, EntityDefinition definition, EntityBases.Base base) {
        ...
        return builder.build(net.minecraft.registry.RegistryKey.of(
                net.minecraft.registry.RegistryKeys.ENTITY_TYPE, id));
    }
    ...
    private DefaultAttributeContainer.Builder attributesFor(EntityDefinition definition,
        ...
        if (definition.defaults.health != null) {
            attributes.add(EntityAttributes.MAX_HEALTH, definition.defaults.health);
        }
    ...
    private void registerSpawnEgg(String namespace, Identifier entityId,
        ...
        // As cores passaram a ser definidas pelo sistema de assets/tint do jogo na 1.21.4.
        // O contrato do manifesto continua preservado; o bridge mantém o tipo e o item registrado.
        Item.Settings eggSettings = new Item.Settings().registryKey(
                net.minecraft.registry.RegistryKey.of(net.minecraft.registry.RegistryKeys.ITEM, eggId));
        Item item = new SpawnEggItem(castMob(type), eggSettings);
