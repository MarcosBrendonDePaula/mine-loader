...
public final class BlockSettingsFactory {
    ...
    public static AbstractBlock.Settings create(ModManifest.BlockDefinition definition) {
        ...
        // Desde a 1.21.4 Settings deixou de carregar loot de outro bloco. O núcleo gera a tabela
        // declarativa; o bridge fica responsável apenas pelas propriedades físicas do bloco.
