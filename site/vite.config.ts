...
const isGitHubPagesBuild = Boolean(process.env.VITE_OUT_DIR);
...
export default defineConfig({
  ...
  build: {
    outDir: process.env.VITE_OUT_DIR ? path.resolve(process.env.VITE_OUT_DIR) : path.resolve(import.meta.dirname, "dist/public"),
